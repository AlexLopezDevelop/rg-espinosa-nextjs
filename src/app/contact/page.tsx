  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-gradient-to-br from-brand-blue to-brand-orange rounded-lg flex items-center justify-center shrink-0 shadow-md">
                    <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                  </div>
                  <div>
                    <div className="font-semibold text-brand-blue">Call Us</div>
                    <div className="text-sm text-gray-500 mb-1">Mon-Fri from 9am to 6pm EST</div>
                    <a href="tel:+17865395217" className="text-brand-blue font-medium hover:underline">+1 786 539 5217</a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="font-semibold text-brand-blue">Email Us</div>
                    <div className="text-sm text-gray-500 mb-1">We respond within 24 hours</div>
                    <a href="mailto:contacto@rygespinosa.com" className="text-brand-blue font-medium hover:underline">contacto@rygespinosa.com</a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="font-semibold text-brand-blue">Visit Us</div>
            ...
            <div className="bg-gray-50 rounded-lg border border-gray-200 p-8">
              <h3 className="text-xl font-semibold text-brand-navy mb-2">Send Us a Message</h3>
              ...
              <form className="space-y-5">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <label htmlFor="privacy" className="text-sm text-gray-600">
                    I agree to the <a href="#" className="text-brand-blue hover:underline">Privacy Policy</a> and consent to being contacted regarding my inquiry.
                  </label>
                </div>
      ...
      <section className="py-16 bg-gray-50 border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-brand-navy mb-12 text-center">Our Offices</h2>
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-6 gap-4">
            {[
              ...
              <div key={i} className="bg-white rounded-lg p-4 border border-gray-200 text-center">
                ...
                <div className="font-semibold text-brand-navy mt-1">{office.city}</div>
                <a href={`tel:${office.phone.replace(/\s/g, '')}`} className="text-sm text-brand-blue hover:underline">{office.phone}</a>
              </div>
            ))}
          </div>

...
const leaders = [
  { name: "Roberto Espinosa", title: "President & CEO", image: "https://images.unsplash.com/photo-1560250097-0b93528c311a?w=400&h=400&fit=crop", bio: "With over 30 years of experience in the insurance industry, Roberto founded R&G Espinosa with a vision to deliver world-class claims adjusting services across the Americas.", tags: ["Strategic Leadership", "Business Development", "International Markets"] },
  { name: "Gustavo Espinosa", title: "Managing Partner", image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&h=400&fit=crop", bio: "Gustavo brings extensive expertise in complex claims management, overseeing operations across multiple jurisdictions.", tags: ["Claims Management", "Operations", "Quality Control"] },
  { name: "Alfredo Espinosa", title: "Managing Director", image: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=400&h=400&fit=crop", bio: "Alfredo specializes in energy and government claims, bringing over 25 years of experience in these complex sectors.", tags: ["Energy Sector", "Government Accounts", "Client Relations"] },
];
  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-gray-50 to-white py-16">
        <div className="max-w-7xl mx-auto px-6">
          <nav className="flex items-center gap-2 text-sm mb-6">
            ...
            <span className="text-[#004E99]">Our Team</span>
          </nav>
          <h1 className="text-4xl lg:text-5xl font-bold text-[#051A2D] mb-4">Our Team</h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-12">
            <Badge variant="secondary" className="mb-4 bg-[#004E99]/10 text-[#004E99]">Executive Team</Badge>
            <h2 className="text-3xl font-bold text-[#051A2D]">Leadership</h2>
          </div>

          <div className="grid lg:grid-cols-3 gap-8">
            {leaders.map((leader, i) => (
              <div key={i} className="bg-white rounded-2xl border border-gray-200 overflow-hidden hover:shadow-xl transition-shadow">
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {leader.tags.map((tag, j) => (
                      <span key={j} className="text-xs px-2 py-1 bg-gray-100 text-gray-600 rounded-full">{tag}</span>
                    ))}
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-12">
            <Badge variant="secondary" className="mb-4 bg-[#004E99]/10 text-[#004E99]">Our Professionals</Badge>
            <h2 className="text-3xl font-bold text-[#051A2D]">Meet the Team</h2>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {team.map((member, i) => (
              <div key={i} className="bg-white rounded-xl p-4 border border-gray-200 hover:shadow-lg transition-shadow text-center">
      ...
      <section className="py-16 bg-gradient-to-r from-[#004E99] to-[#22A9FF]">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <Badge variant="secondary" className="mb-4 bg-white/20 text-white">Join Our Team</Badge>
          <h2 className="text-3xl font-bold text-white mb-4">Build Your Career With Us</h2>
